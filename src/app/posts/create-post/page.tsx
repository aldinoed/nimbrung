...
export default function Publish() {
  ...
  return (
    <div className=" min-h-screen max-h-screen min-w-full px-20 max-w-full flex flex-col justify-evenly items-center bg-white">
      <div className="border shadow rounded max-w-full min-w-full">
        <form className=" max-w-full min-w-full  mx-auto pt-20 ps-20 pe-20" onSubmit={handleSubmit}>
          <h1 className="text-center font-sans font-bold antialiased">Mau ngajak diskusi apa hari ini?</h1>
          <div className="mb-5">
